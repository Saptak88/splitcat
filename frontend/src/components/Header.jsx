    ...
    return (
        <div className="navbar p-0">
            <div className="navbar-top pe-sm-5 ps-sm-5 pe-2 ps-2 border-bottom border-subtle">
                ...
                <div className="ms-1 ms-sm-4 me-2 me-sm-0 dropdown">
                    <div className="user-profile-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div className="large-display fw-medium ms-2">{userInfo ? userInfo.email.split("@")[0] : ""}</div>
                    </div>
                    <ul className="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <Link className="dropdown-item" href="/signout" onClick={logouthandler}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    width="20"

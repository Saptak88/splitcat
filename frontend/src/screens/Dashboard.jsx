                    ...
                    <div className="row border-bottom border-subtle m-0 p-0 dashboard-balance">
                        <div className="col border-end border-subtle align-items-center d-flex">
                            <div className="col balance">
                                ...
                                <div className="row balance-column">
                                    <p className={`text-center  fs-6   ${total < 0 ? "text-danger" : "text-success"}`}>
                        ...
                        <div className="col border-end border-subtle align-items-center d-flex">
                            <div className="col balance">
                                ...
                                <div className="row balance-column">
                                    <p className={`text-center fs-6   ${yo < 0 ? "text-danger" : "text-secondary"}`}>${Math.abs(yo)}</p>
                                </div>
                            </div>
                        </div>
                        <div className="col align-items-center d-flex">
                            <div className="col balance">
                                ...
                                <div className="row balance-column ">
                                    <p className={`text-center fs-6  ${yao <= 0 ? "text-secondary" : "text-success"}`}>${Math.abs(yao)}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="dashboard-main-top">
                            <div className="row p-0 m-0">
                                <div className="col p-0 m-0">
                                    <p className="fs-5 fw-medium ps-2  text-center border-bottom border-subtle  text-body-tertiary">
                                        You owe
                                    </p>
                                    {groupedItems &&
                                        groupedItems.map(
                                ...
                                <div className="col p-0 m-0 border-start border-subtle">
                                    <p className="fs-5 fw-medium pe-2 text-center border-bottom border-subtle  text-body-tertiary">
                                        You are owed
                                    </p>
                                    {groupedItems &&
                                        groupedItems.map(
